  ...
  return (
    ...
    >
      <ul className="m-auto flex flex-grow flex-col items-center justify-start gap-[6px]">
        ...
        <NavLink to={"./placement"} className="w-full font-medium">
          <li className="flex gap-2 duration-200 rounded-md px-4 py-2 hover:bg-violet-600/40 ">
            <GiGraduateCap className="pt-[0.1rem] text-2xl  " />
            Placement
          </li>
        </NavLink>
        ...
        {user.role === "HOD" && (
          <>
            ...
            <NavLink to={"./add_placement"} className="w-full font-medium">
          <li className="flex gap-2 duration-200 rounded-md px-4 py-2 hover:bg-violet-600/40 ">
            <BiSolidEdit className="pt-[0.1rem] text-2xl  " />
             Add Placement
          </li>
        </NavLink>
